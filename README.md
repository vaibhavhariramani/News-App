...
A Flutter App.
Using Login API =  https://www.getpostman.com/collections/299632c9a18ed457ba78
Using News API  =   https://api.first.org/data/v1/news 
...
## Features
> Bookmark your Fav. News
> SignUp 
> SignIn

# Download

[<img width="150" align='center' src="https://archive.org/download/download-button-png/download-button-png.png">](newsApp.apk)
